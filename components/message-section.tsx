...
export function MessageSection({ language }: MessageSectionProps) {
  const content = {
    ar: {
      ...
      message:
        "إخواننا في فلسطين، نعتذر لكم عن تقصيرنا، ولكننا لن نترككم وحدكم. كل جنيه نتبرع به هو رسالة حب ودعم لكم. معاً سنقف بجانبكم حتى تحرير فلسطين السلام على أهل السلام والصبر والرضا والإيمان رسالة من قلب موجوع إلى غزة… إلى فلسطين… إلى الجرح النازف في صدر الأمة… أعتذر. أعتذر باسم الصمت الذي خذلكم، أعتذر باسم العجز الذي بات سلوكًا عامًا، أعتذر لأننا اكتفينا بالمشاهدة، بالدعاء، بالتفاعل الباهت على الشاشات. سامحونا إن سقطت من أعينكم كل الشعوب التي كانت يومًا تُدعى إسلامية وعربية سامحونا إن خذلتكم أنظمتنا، وإن خذلناكم نحن بسكوتنا، ببرودنا، بتعوّدنا على مشاهد الدم والرماد. كنا نظن أن الأمة واحدة، فإذا بنا شعوب متفرقة، تتكلم كثيرًا، وتفعل قليلًا. كنا نحلم أن نكون معكم في الصفوف الأولى، فإذا بنا في آخر طابور الإنسانية. غزة. نحن لا نستحق صمودك. ولا نستحق دماء أطفالك التي سالت ونحن نغني، نلهو، ننام في أمان، ونتفرج على بطولاتك كأنها مشهد سينمائي لا يعنينا. لكن رغم الخذلان، ورغم صمت العالم، نعلم أن الله لا ينسى، وأن وعده حق، وأن نصره آتٍ، ولو بعد حين. وإن كان فينا بقية من حياة… فلن ننسى. والسلام على أهل العزة، إن بقي للسلام معنى.  الحمله  من أجل فلسطين. دعماً لا ينقطع حملة مصرية شعبية يومية لدعم أهلنا في فلسطين ندعو كل مصري ومصرية، وكل صاحب مهنة أو تجارة، أن يكون له سهم في هذه الحملة المباركة، حيث نطرح مبادرة تبرع يومي رمزي يبدأ من 1 جنيه فقط، ليجتمع القليل فيصنع الفرق الكبير. -- 🇵🇸 حملة جنيه في الخير من الشعب المصري لدعم فلسطين من كل مواطن.. جنيه واحد يوميًا يصنع فرقًا عظيمًا.
    },
    en: {
